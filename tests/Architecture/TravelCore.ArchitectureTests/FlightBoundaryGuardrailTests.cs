...
/// <summary>
/// TC-P22-T001 / T002: independent Flight module, schema flight, FlightBooking itinerary/passenger aggregate; Tour transport stays Tour-owned.
/// </summary>
public sealed class FlightBoundaryGuardrailTests
{
    ...
    public void Flight_DoesNot_Own_Peer_Or_T001_Forbidden_Product()
    {
        ...
        Assert.NotNull(typeof(FlightDomainAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Domain.FlightBooking"));
        ...
        Assert.NotNull(typeof(FlightContractsAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Contracts.IFlightSearchSource"));
        ...
        Assert.NotNull(typeof(FlightContractsAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Contracts.IFlightCancellationSource"));
        ...
        Assert.NotNull(typeof(FlightDomainAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Domain.FlightBookingCancellation"));
        Assert.Null(typeof(FlightDomainAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Domain.PNR"));
        ...
        Assert.NotNull(typeof(FlightDomainAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Domain.FlightOfferSnapshot"));
        Assert.NotNull(typeof(FlightDomainAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Domain.FlightBookingMonetarySnapshot"));
        Assert.NotNull(typeof(FlightDomainAssemblyMarker).Assembly.GetType("TravelCore.Modules.Flight.Domain.FlightFareRulesSnapshot"));
        Assert.Equal("external source-authoritative", FlightOwnershipBoundary.InventoryAuthority);
        ...
        Assert.Equal("Search, AvailabilityCheck, OfferRevalidation, ReservationCreate, ReservationQuery, TicketCreate, TicketQuery, CancellationQuote, ReservationCancel, TicketVoid, TicketRefund, CancellationQuery", FlightOwnershipBoundary.SourceCapabilities);
        ...
        Assert.True(FlightReservationOwnershipBoundary.CancellationExecutionImplemented);
        Assert.Equal(
    ...
    public void Flight_Evidence_Keeps_Ascii_Invariants()
    {
        ...
        Assert.Contains("P22-R2 = RESOLVED", text, StringComparison.Ordinal);
