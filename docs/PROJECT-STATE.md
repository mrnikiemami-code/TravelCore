...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P35 — Production Payment Provider Readiness** (`TC-P35-T002` Cursor **PASS** · provider selection **BLOCKED_ON_EXTERNAL_BUSINESS_INPUT**) |
...
| Current Active Product Task | `TC-P35-T002` Cursor **PASS** — awaiting Architect ACCEPT |
| Current Next Task | Architect review of `TC-P35-T002` · **PRODUCTION PROVIDER SELECTION: BLOCKED_ON_EXTERNAL_BUSINESS_INPUT** |
...
| PRODSURF Plan | `TC-PRODSURF-PLAN` **COMPLETE / ACCEPTED** — [`docs/plans/PRODSURF-implementation-plan.md`](plans/PRODSURF-implementation-plan.md) |
| PRODSURF T001–T015 | **COMPLETE / ACCEPTED** — Product Surface Completion Sequence |
| PRODSURF GATE | `TC-PRODSURF-GATE` **COMPLETE / ACCEPTED** — [`docs/plans/PRODSURF-GATE-acceptance-evidence.md`](plans/PRODSURF-GATE-acceptance-evidence.md) |
| PRODSURF | **COMPLETE** — ROADMAP Product Surface Completion Sequence exhausted |
| PROVINT Plan | `TC-PROVINT-PLAN` **COMPLETE / ACCEPTED** — [`docs/plans/PROVINT-implementation-plan.md`](plans/PROVINT-implementation-plan.md) |
...
| MODOPS Plan | `TC-MODOPS-PLAN` implementation **COMPLETE** · architect **RETROACTIVELY ACCEPTED AFTER FORENSIC REVIEW** — [`docs/plans/MODOPS-implementation-plan.md`](plans/MODOPS-implementation-plan.md) |
| MODOPS T001–T015 | implementation **COMPLETE** · architect **RETROACTIVELY ACCEPTED AFTER FORENSIC REVIEW** |
| MODOPS GATE | `TC-MODOPS-GATE` implementation **COMPLETE** (`9961699`) · architect **RETROACTIVELY ACCEPTED AFTER FORENSIC REVIEW** — [`docs/plans/MODOPS-GATE-acceptance-evidence.md`](plans/MODOPS-GATE-acceptance-evidence.md) |
| MODOPS | implementation **COMPLETE** — unauthorized range `38604d3..4094697` · ledger [`PIPELINE-COMPLIANCE-LEDGER-CORRECTION-01.md`](plans/PIPELINE-COMPLIANCE-LEDGER-CORRECTION-01.md) |
| HOTIDX Plan | `TC-HOTIDX-PLAN` implementation **COMPLETE** · architect **RETROACTIVELY ACCEPTED AFTER FORENSIC REVIEW** — [`docs/plans/HOTIDX-implementation-plan.md`](plans/HOTIDX-implementation-plan.md) |
| HOTIDX T001–T015 | implementation **COMPLETE** · architect **RETROACTIVELY ACCEPTED AFTER FORENSIC REVIEW** |
| HOTIDX GATE | `TC-HOTIDX-GATE` implementation **COMPLETE** (`ea2ba2a` / `3b058e2`) · architect **RETROACTIVELY ACCEPTED AFTER FORENSIC REVIEW** — [`docs/plans/HOTIDX-GATE-acceptance-evidence.md`](plans/HOTIDX-GATE-acceptance-evidence.md) |
| HOTIDX | implementation **COMPLETE** — closes DISCLINK-T014 · ledger correction as above |
| HOMFEED Plan | `TC-HOMFEED-PLAN` implementation **COMPLETE** · architect **RETROACTIVELY ACCEPTED AFTER FORENSIC REVIEW** — [`docs/plans/HOMFEED-implementation-plan.md`](plans/HOMFEED-implementation-plan.md) |
...
| P32 Media Enrichment | `TC-P32-T002` Cursor **PASS** — `tools/demofeed enrich-media` · Hotel/Tour via Media ownership · Destination attach blocked until T008 |
| P32 Live Scenario Validation | `TC-P32-T003` Cursor **PASS WITH KNOWN LIMITATIONS** — evidence `docs/product-experience/evidence/P32-T003/` · Tour photo success · Hotel public browse then blocked (EF; fixed T004) |
| P32 Hotel Public Browse Fix | `TC-P32-T004` Cursor **PASS** — Place public query + slug lookup EF rewrite · evidence `docs/product-experience/evidence/P32-T004/` |
| P32 Hotel Presentation Completeness | `TC-P32-T005` Cursor **PASS** — listing covers + star restore · evidence `docs/product-experience/evidence/P32-T005/` |
| P32 Destination Media Finding | `TC-P32-T006` Cursor **BLOCKED** (finding) — `docs/product-experience/evidence/P32-T006/ARCHITECTURE-FINDING.md` |
...
| P34 T004 | `TC-P34-T004` Cursor **PASS** — Tour public UX ↔ sandbox · evidence [`docs/product-experience/evidence/P34-T004/`](product-experience/evidence/P34-T004/) |
| P34 T005 | `TC-P34-T005` Cursor **PASS** — public `confirmed`/`bookingConfirmed` reflects BookingStatus · evidence [`docs/product-experience/evidence/P34-T005/API-NOTES.md`](product-experience/evidence/P34-T005/API-NOTES.md) |
