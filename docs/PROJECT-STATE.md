...
| Current Active Product Task | `TC-P27-T007` — event ingestion / publisher interaction boundary (IMPLEMENTED / AWAITING_ARCHITECT_REVIEW) |
...
| P27 | **IN_PROGRESS** — `TC-P27-T007` implemented · **P27-R1–R4,R6 RESOLVED** · R5,R7,R8 OPEN |
...
| P27 T007 | `TC-P27-T007` implemented / AWAITING_ARCHITECT_REVIEW — ingestion/publisher boundary; **P27-R4/R6 RESOLVED** |
