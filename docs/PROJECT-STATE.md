...
| Current Active Product Task | `TC-P27-T006` — provider abstraction / dispatch boundary (IMPLEMENTED / AWAITING_ARCHITECT_REVIEW) |
...
| P27 | **IN_PROGRESS** — `TC-P27-T006` implemented · **P27-R1–R3 RESOLVED** · R4–R8 OPEN |
...
| P27 T006 | `TC-P27-T006` implemented / AWAITING_ARCHITECT_REVIEW — provider abstraction boundary; **P27-R3 RESOLVED** |
