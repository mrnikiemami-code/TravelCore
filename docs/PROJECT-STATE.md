...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P22 — Flight** (**IN_PROGRESS** — `TC-P22-PLAN` ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1 = RESOLVED** · **P22-R2–R8 OPEN** · T001 implemented / awaiting architect review · T002 NOT EXECUTED · P21 COMPLETE) |
...
| Current Active Product Task | `TC-P22-T001` — Flight module/schema foundation (implemented / AWAITING_ARCHITECT_REVIEW) |
| Current Next Task | Return `TC-P22-T001 RESULT`; do **not** execute T002 until T001 ACCEPTED and P22-R2 locked |
| P01 | **COMPLETE** |
...
| P22 | **IN_PROGRESS** — PLAN ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1 = RESOLVED** · **P22-R2–R8 OPEN** · T001 implemented / awaiting review · T002 NOT EXECUTED · P23 NOT STARTED |
...
| P22-T001 | **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** — independent Flight module · schema `flight` · FlightBooking owned inside Flight but not implemented · TourDepartureTransportSegment remains Tour-owned · Named Flight Supplier = NONE |
