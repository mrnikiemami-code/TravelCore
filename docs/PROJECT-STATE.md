...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P19 — Tour Booking** (**IN PROGRESS** — T002 aggregate/lifecycle; **P19-R1–R2 RESOLVED**; R3–R8 OPEN) |
...
| Current Active Product Task | `TC-P19-T002` — Booking aggregate + minimal lifecycle (AWAITING_ARCHITECT_REVIEW) |
| Current Next Task | Architect review of `TC-P19-T002` → T003 only after ACCEPT and P19-R3 lock |
| P01 | **COMPLETE** |
...
| P19 | **IN PROGRESS** — Plan ACCEPTED · **P19-R1–R2 RESOLVED** · R3–R8 OPEN · T002 aggregate/lifecycle |
...
| P19-T002 | **DELIVERED** — Booking aggregate + Pending/Confirmed/Cancelled lifecycle (`bookings` table) |
| P19-R1 (Booking ownership / schema / target) | **RESOLVED** — independent Booking module · schema `booking` · initial target = TourDeparture (logical) · Tour owns capacity definition · Booking owns consumption (not implemented; R3 OPEN) |
