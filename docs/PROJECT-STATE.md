...
| P21-T005 | **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** — HotelBookingStatus Pending/Confirmed/Cancelled · `IHotelReservationSource` · HotelSupplierReservation + attempts + idempotency + reconciliation · Production Hotel Reservation Source = NONE · confirmation is not Payment-driven · T006 NOT EXECUTED |
