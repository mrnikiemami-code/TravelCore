...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P23 — Dynamic Package / Flight + Hotel** (**IN_PROGRESS** — T001–T006 implemented · **P23-R1 RESOLVED** · **P23-R2–R6 OPEN** · **P23-R7–R8 OPEN** · AWAITING_ARCHITECT_REVIEW · P23 not COMPLETE) |
...
| Current Active Product Task | `TC-P23-T007` — DynamicPackage confirmation / consistency boundary (AWAITING_ARCHITECT_REVIEW; T008 NOT EXECUTED) |
| Current Next Task | Return `TC-P23-T007 RESULT`; do **not** execute `TC-P23-T008` |
| P01 | **COMPLETE** |
...
| P23 | **IN_PROGRESS** — T001–T007 implemented · **P23-R1 RESOLVED** · **P23-R2–R7 OPEN** · **P23-R8 OPEN** · AWAITING_ARCHITECT_REVIEW · P23 not COMPLETE |
