...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P22 — Flight** (**IN_PROGRESS** — `TC-P22-PLAN` ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1 = RESOLVED** · **P22-R2 = RESOLVED** · **P22-R3–R8 OPEN** · T001 ACCEPTED · T002 implemented / awaiting architect review · T003 NOT EXECUTED · P21 COMPLETE) |
...
| Current Active Product Task | `TC-P22-T002` — FlightBooking itinerary/passenger structure (implemented / AWAITING_ARCHITECT_REVIEW) |
| Current Next Task | Return `TC-P22-T002 RESULT`; do **not** execute T003 until T002 ACCEPTED and P22-R3 locked |
| P01 | **COMPLETE** |
...
| P22 | **IN_PROGRESS** — PLAN ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1 = RESOLVED** · **P22-R2 = RESOLVED** · **P22-R3–R8 OPEN** · T001 ACCEPTED · T002 implemented / awaiting review · T003 NOT EXECUTED · P23 NOT STARTED |
...
| P22-T002 | **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** — FlightBooking aggregate · OneWay/RoundTrip · journeys/segments · IATA Airport/Airline references · Adult/Child/Infant passengers · no status/search/offer/PNR/Payment/API |
