...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P36 GATE** (`TC-P36-GATE` Cursor **PASS WITH KNOWN LIMITATIONS** · overall **PARTIALLY_SELLABLE_VISUALLY**) |
...
| Current Active Product Task | `TC-P36-GATE` Cursor **PASS WITH KNOWN LIMITATIONS** — awaiting Architect ACCEPT |
| Current Next Task | Architect review of GATE · do not infer P37 |
