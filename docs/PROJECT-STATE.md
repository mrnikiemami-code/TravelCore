...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P19 — Tour Booking** (**IN PROGRESS** — T003 capacity hold; **P19-R1–R3 RESOLVED**; R4–R8 OPEN) |
...
| Current Active Product Task | `TC-P19-T003` — Capacity hold / expiry / concurrency (AWAITING_ARCHITECT_REVIEW) |
...
| P19 | **IN PROGRESS** — Plan ACCEPTED · **P19-R1–R3 RESOLVED** · R4–R8 OPEN · T003 capacity hold |
...
| P19-T003 | **DELIVERED** — CapacityHold + DepartureCapacityAccount + atomic overbooking protection |
