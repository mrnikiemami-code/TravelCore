...
| Current Active Product Task | `TC-P20-T007` — Public Booking payment journey, authorization, transactional reads, and privacy boundary, awaiting architect review |
...
| P20 | **IN PROGRESS** — PLAN ACCEPTED · **P20-R1–R7 = RESOLVED** · **P20-R8 OPEN** · T007 public Payment journey delivered, awaiting acceptance [`docs/plans/P20-implementation-plan.md`](plans/P20-implementation-plan.md) |
...
| P20-T007 | **IMPLEMENTED / AWAITING ACCEPTANCE** (`542cee9`) — Booking-scoped public Payment initiate/status · reuse Booking access token · private payment/return pages · noindex · no card collection · no public Refund API · honest no-provider state |
