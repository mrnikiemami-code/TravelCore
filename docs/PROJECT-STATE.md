...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P22 — Flight** (**IN_PROGRESS** — `TC-P22-PLAN` ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1–R3 = RESOLVED** · **P22-R4–R8 OPEN** · T003 awaiting review · T004 NOT EXECUTED · P21 COMPLETE) |
...
| Current Active Product Task | `TC-P22-T003` — Flight search/availability source boundary (implemented / AWAITING_ARCHITECT_REVIEW) |
...
| P22 | **IN_PROGRESS** — PLAN ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1–R3 = RESOLVED** · **P22-R4–R8 OPEN** · T001–T002 ACCEPTED · T003 implemented / awaiting review · T004 NOT EXECUTED · P23 NOT STARTED |
