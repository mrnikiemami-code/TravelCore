...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P20 — Payment** (**PLAN ACCEPTED** · **P20-R1–R5 = RESOLVED** · **P20-R6–R8 OPEN** · T005 obligation binding + confirmation) |
...
| Current Active Product Task | `TC-P20-T005` — authoritative Booking obligation binding + payment-driven Booking confirmation (IN PROGRESS) |
| Current Next Task | Implement T005 per architect envelope (baseline `f286d9f`) → do **not** execute T006 until T005 ACCEPTED; do not invent P20-R6–R8 |
| P01 | **COMPLETE** |
...
| P20 | **IN PROGRESS** — PLAN ACCEPTED · **P20-R1–R5 = RESOLVED** · **P20-R6–R8 OPEN** · T005 obligation binding + confirmation [`docs/plans/P20-implementation-plan.md`](plans/P20-implementation-plan.md) |
...
| P20-T005 | **IN PROGRESS** — PaymentExecutionSnapshot · Booking obligation binding · amount/currency integrity · payment-driven Booking confirmation |
