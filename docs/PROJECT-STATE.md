...
| Current Active Product Task | `TC-P22-GATE` — Flight acceptance gate (AWAITING_ARCHITECT_REVIEW; P23 NOT STARTED) |
...
| P22 | **COMPLETE** — GATE evidence [`docs/plans/P22-GATE-acceptance-evidence.md`](plans/P22-GATE-acceptance-evidence.md) · **P22-R1–R8 RESOLVED** · T001–T009 ACCEPTED · GATE AWAITING_ARCHITECT_REVIEW · P23 NOT STARTED |
...
| P22-GATE | **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** — [`docs/plans/P22-GATE-acceptance-evidence.md`](plans/P22-GATE-acceptance-evidence.md); P22 COMPLETE; P23 NOT STARTED |
