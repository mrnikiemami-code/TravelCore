...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P21 — Hotel Booking** (**IN_PROGRESS** — `TC-P21-PLAN` ACCEPTED · **P21-R1–R3 RESOLVED** · **P21-R4–R8 OPEN** · T003 lineage VERIFY awaiting review; T003 not architect-accepted) |
...
| Current Active Product Task | `TC-P21-T003-VERIFY` — Verify T003 baseline lineage and R3 availability-hold evidence (AWAITING_ARCHITECT_REVIEW; parent `TC-P21-T003` not architect-accepted) |
...
| P21 | **IN_PROGRESS** — `TC-P21-PLAN` ACCEPTED [`docs/plans/P21-implementation-plan.md`](plans/P21-implementation-plan.md) · **P21-R1–R3 RESOLVED** · **P21-R4–R8 OPEN** · T003-VERIFY awaiting review; T003 not architect-accepted |
...
| P21-T003 | **IMPLEMENTED / LINEAGE VERIFICATION PENDING** (`2696407` / docs `77a9b8f`) — IHotelAvailabilitySource port · HotelAvailabilityHold Requested/Active/Released/Expired · one hold covers complete room set · production source NONE · no fake production availability · **not architect-accepted** |
| P21-T003-VERIFY | **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** (`5824acd`) — explained `a844bcf`→`a0f5c99` as T002 result docs only · stay test asserts lead guest on ordinal-ordered room · T004 not executed |
