...
| Current Active Product Task | `TC-P10-T001` — AWAITING_ARCHITECT_REVIEW |
...
| P10-T001 | **AWAITING_ARCHITECT_REVIEW** — Experience specialization foundation (`tour_experience_specializations` 1:1) |
| P10-R1 (Experience specialization + Itinerary ownership) | **PARTIAL** — attachment 1:1 delivered in T001; itinerary ownership still open (T002) |
...
| Phase Transition State | **P10_T001_REVIEW** · `TC-P10-PLAN` ACCEPTED · `TC-P10-T001` awaiting architect ACCEPT · Auto-Execute T002 pending |
...
| Pipeline Product Execution | **NORMAL — AWAITING_ARCHITECT_REVIEW** (`TC-P10-T001`) |
...
| TC-P10-T001 | Experience specialization scaffolding | AWAITING_ARCHITECT_REVIEW | (this commit) |
