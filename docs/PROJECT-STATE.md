...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P22 — Flight** (**IN_PROGRESS** — `TC-P22-PLAN` ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1–R7 = RESOLVED** · **P22-R8 OPEN** · T006 ACCEPTED · T007 implemented / awaiting review · T008 NOT EXECUTED · P21 COMPLETE) |
...
| Current Active Product Task | `TC-P22-T007` — Flight confirmed cancellation / ticket void-refund / Payment refund policy (implemented / AWAITING_ARCHITECT_REVIEW) |
| Current Next Task | Return `TC-P22-T007 RESULT`; do **not** execute T008 until T007 ACCEPTED and P22-R8 locked |
| P01 | **COMPLETE** |
...
| P22 | **IN_PROGRESS** — PLAN ACCEPTED [`docs/plans/P22-implementation-plan.md`](plans/P22-implementation-plan.md) · **P22-R1–R7 = RESOLVED** · **P22-R8 OPEN** · T001–T006 ACCEPTED · T007 implemented / awaiting review · T008 NOT EXECUTED · P23 NOT STARTED |
...
| P22-T007 | **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** — confirmed Flight cancellation process · ticket void/refund ≠ Payment Refund · FullRefund/NoRefund · partial blocked · Production cancellation source = NONE · **TC-P22-T008 NOT EXECUTED** |
