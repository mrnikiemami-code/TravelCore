...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P37 — Experience Platform Foundation** (`TC-P37-T004` Cursor **PASS** · Admin Console · **READY_FOUNDATION**) |
...
| Current Active Product Task | `TC-P37-T004` Cursor **PASS** — awaiting Architect ACCEPT |
| Current Next Task | Architect review of `TC-P37-T004` · do not auto-implement T005+ |
