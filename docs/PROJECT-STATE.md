...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P12 — Pricing** (**IN PROGRESS** — T006 Admin Pricing baseline) |
...
| Last Accepted Commit | `c90931d` (`TC-P12-T005`) · occupancy/passenger baseline accepted |
...
| Current Active Product Task | `TC-P12-T006` — Admin Pricing baseline (AWAITING_ARCHITECT_REVIEW) |
| Current Next Product Phase | P12 — Pricing |
| Current Next Task | Architect review of T006 Admin Pricing baseline |
| P01 | **COMPLETE** |
...
| P12 | **IN PROGRESS** — Plan authored · **P12-R1/R2/R3/R4/R5/R6 RESOLVED** |
...
| P12-T006 | **AWAITING_ARCHITECT_REVIEW** — Admin Pricing baseline (Pricing-owned Admin API + Access `pricing.prices.read`/`write`) |
...
| Phase Transition State | **P10_T006_IN_PROGRESS** · T001–T005 ACCEPTED · P10-R1/R2/R3/R5/R6/R7 RESOLVED · R4/R8 UNRESOLVED |
...
| TC-P12-T006 | Admin Pricing baseline | AWAITING_ARCHITECT_REVIEW | (this commit) |
...
Tour · Pricing (Price + Quote baseline · PriceComponent · occupancy rules · Admin Pricing API · Money · schema `pricing` · P12-R1/R2/R3/R4/R5/R6) · Visa · Booking · Payment
