...
| TC-P05-T012 | AWAITING_ARCHITECT_REVIEW (`0c8ab0a`; hygiene `3351755`) |
...
| TC-P05-T012 | Phase hardening tests & evidence pack | AWAITING_ARCHITECT_REVIEW | `0c8ab0a` (+ `3351755`) |
