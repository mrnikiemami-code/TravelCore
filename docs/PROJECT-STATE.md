...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P37 — Experience Platform Foundation** (`TC-P37-T002` Cursor **PASS** · Customer Dashboard · **READY_FOUNDATION**) |
...
| Current Active Product Task | `TC-P37-T002` Cursor **PASS** — awaiting Architect ACCEPT |
| Current Next Task | Architect review of `TC-P37-T002` · do not auto-implement Agency Portal |
