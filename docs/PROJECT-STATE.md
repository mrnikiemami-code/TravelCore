...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P21 — Hotel Booking** (**IN_PROGRESS** — `TC-P21-PLAN` ACCEPTED · **P21-R1–R4 RESOLVED** · **P21-R5–R8 OPEN** · T003 ACCEPTED · T004 awaiting architect review · T005 NOT EXECUTED) |
...
| Current Active Product Task | `TC-P21-T004` — Hotel commercial rate offer, immutable monetary snapshot, cancellation-policy snapshot (AWAITING_ARCHITECT_REVIEW; T005 NOT EXECUTED) |
...
| P21 | **IN_PROGRESS** — `TC-P21-PLAN` ACCEPTED [`docs/plans/P21-implementation-plan.md`](plans/P21-implementation-plan.md) · **P21-R1–R4 RESOLVED** · **P21-R5–R8 OPEN** · T003 ACCEPTED · T004 awaiting architect review · T005 NOT EXECUTED |
...
| P21-T004 | **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** — `IHotelRateOfferSource` · immutable `HotelRateOfferSnapshot` / `HotelBookingMonetarySnapshot` / `HotelCancellationPolicySnapshot` · Production Hotel Rate Source = NONE · no fake production prices · Pricing module not generalized · P20 Partial Refund remains DEFERRED · T005 NOT EXECUTED |
