...
| فیلد | مقدار |
|------|--------|
| Current Phase | **P12 — Pricing** (**IN PROGRESS** — T004 Quote baseline) |
...
Tour · Pricing (Price + Quote baseline · PriceComponent · Money · schema `pricing` · P12-R1/R2/R3/R4) · Visa · Booking · Payment
