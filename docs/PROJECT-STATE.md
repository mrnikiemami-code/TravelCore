...
| P20-T007 | **IMPLEMENTED / AWAITING ACCEPTANCE** — Booking-scoped public Payment initiate/status · reuse Booking access token · private payment/return pages · noindex · no card collection · no public Refund API · honest no-provider state |
