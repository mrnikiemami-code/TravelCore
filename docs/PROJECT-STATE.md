...
| P20-T008 | **IMPLEMENTED / AWAITING ACCEPTANCE** — provider capability model · zero production providers valid · internal read-only operational Payment/Refund query · no manual financial mutation · adapter checklist · no real provider SDK |
