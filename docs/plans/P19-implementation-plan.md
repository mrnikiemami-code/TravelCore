...
- Purpose: Transaction-time people facts (**P19-R4**).
- Preserve: **PlannerTravelerComposition ≠ BookingPassenger** · **BookingPassenger ≠ Party** · **Booker ≠ Identity Account entity**. No passport upload by default. No Party clone.
