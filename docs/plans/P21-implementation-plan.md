...
| Status | PLAN ACCEPTED · **P21-R1 = RESOLVED** · **P21-R2 = RESOLVED** · **P21-R3 = RESOLVED** · **P21-R4 = RESOLVED** · **P21-R5 = RESOLVED** · **P21-R6 = RESOLVED** · **P21-R7 = RESOLVED** · **P21-R8 = OPEN** · T006 ACCEPTED (`f2d4946` / docs `790765b`) · T007 implemented / AWAITING_ARCHITECT_REVIEW · T008 NOT EXECUTED |
...
- Depends on **P21-R7**. **IMPLEMENTED / AWAITING_ARCHITECT_REVIEW** — Confirmed HotelBooking cancellation via `HotelBookingCancellation` (Requested / SupplierCancellationPending / RefundPending / Completed) · immutable policy evaluation at RequestedAt · `HotelSupplierCancellationAttempt` Created/Initiated/Confirmed/Failed · Penalty=0 full Refund after authoritative supplier cancel · Penalty=Total completes without Refund · partial penalty blocked before supplier side effect · Partial Refund DEFERRED · amendments/rebooking DEFERRED · PayAtProperty/deposit DEFERRED · no public cancellation API/UI · Named Hotel Supplier = NONE · Production Payment Provider = NONE · T008 NOT EXECUTED.

### TC-P21-T008 — Public UX / authorization / privacy / operational reads / provider readiness

- Depends on **P21-R8**. **NOT EXECUTED**.
