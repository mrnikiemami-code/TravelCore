...
> **Envelope note:** `TC-Post-P29-PLAN` authoring · **do not start product tasks without architect execution envelopes**.
...
| ID | Topic | Status |
|----|-------|--------|
| `Post-P29-R1` | Metrics-driven evolution gate vs speculative roadmap delivery | **OPEN** |
| `Post-P29-R2` | Dedicated search engine evolution boundary vs P15 Search | **OPEN** |
| `Post-P29-R3` | Provider expansion boundary | **OPEN** |
| `Post-P29-R4` | Personalization / recommendation evolution boundary | **OPEN** |
| `Post-P29-R5` | Loyalty / promotions evolution boundary | **OPEN** |
| `Post-P29-R6` | Advanced pricing evolution boundary | **OPEN** |
| `Post-P29-R7` | Mobile app / client expansion boundary | **OPEN** |
| `Post-P29-R8` | Module extraction / microservice evolution boundary + deferred scope | **OPEN** |
...
1. `TC-Post-P29-PLAN` — Post-P29 architecture implementation plan
2. `TC-Post-P29-T002` — continuous evolution foundation boundary
3. `TC-Post-P29-T003` — metrics-driven evolution gate boundary
4. `TC-Post-P29-T004` — dedicated search engine evolution boundary
5. `TC-Post-P29-T005` — provider expansion boundary
6. `TC-Post-P29-T006` — personalization / recommendation evolution boundary
7. `TC-Post-P29-T007` — loyalty / promotions evolution boundary
8. `TC-Post-P29-T008` — advanced pricing + mobile + module extraction + deferred scope boundaries
9. `TC-Post-P29-T009` — evidence pack
10. `TC-Post-P29-GATE` — acceptance gate
...
- Delivered (future): `docs/plans/Post-P29-GATE-acceptance-evidence.md` · gate evidence architecture lock test · SoT sync marking **Post-P29 COMPLETE**.
...
- Delivered (future): `TravelCore.Evolution` · `EvolutionFoundationBoundary` · `EvolutionOwnershipBoundary` · guardrail tests.
