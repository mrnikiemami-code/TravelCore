...
| **P11-R8** | Public Departure visibility | **RESOLVED** | Only `TourDepartureStatus.Published` is public; Published ≠ Bookable (no Booking/Pricing/Payment/availability invent) (TC-P11-T009) |
