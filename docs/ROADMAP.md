...
|------|--------|
| Project | TravelCore |
| Current Phase | **P37 — Experience Platform Foundation** (`TC-P37-T004` Cursor **PASS** · Admin Console) |
...
**Status:** **ACTIVE** (`TC-P37-T004` Cursor **PASS** · Admin Console · **READY_FOUNDATION**)

Plan: [`docs/plans/P37-experience-architecture-review.md`](plans/P37-experience-architecture-review.md)

Customer: `/[locale]/me` · Agency: `/[locale]/agency` · Admin: `/[locale]/admin` · evidence T002/T003/T004

Recommended next: await Architect `.task.md` (do not auto-run T005+)
...
| P37 | Experience Platform Foundation | **ACTIVE** (`TC-P37-T004` · Admin Console READY_FOUNDATION) |
