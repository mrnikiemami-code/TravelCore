...
| Current Next Task | Architect review of `TC-P36-T003` · do not auto-implement T004 |
...
**Status:** **ACTIVE** (`TC-P36-T003` Cursor **PASS** · Hotels awaiting Architect)

```text
PARTIALLY_SELLABLE_VISUALLY (Home + Hotels)
```

Evidence: [`docs/product-experience/evidence/P36-T003/`](../product-experience/evidence/P36-T003/)
...
| P36 | Commercial UI/UX Final Polish | **ACTIVE** (`TC-P36-T003` · Hotels PARTIALLY_SELLABLE) |
