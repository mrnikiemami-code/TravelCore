...
- **P04** = IN_PROGRESS (`TC-P04-PLAN` ACCEPTED `9d264e6`; `TC-P04-T001` ACCEPTED `5de2ae1`; `TC-P04-T002` ACCEPTED `3363cf1`; `TC-P04-T003` ACCEPTED `9176dbe`; `TC-P04-T004` AWAITING_ARCHITECT_REVIEW)
