...
- **P25** = IN_PROGRESS (plan authored; `TC-P25-T002` implemented / awaiting architect review)
...
**Status:** IN_PROGRESS (plan authored; T002 documentation alignment executed)
...
| P25 | Notification | IN_PROGRESS (plan authored; T002 executed) |
