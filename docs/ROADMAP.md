...
| Current Next Task | Architect review of `TC-P02-T011`; then `TC-P02-T012` when issued |
...
- **P00** = COMPLETE
- **P01** = COMPLETE
- **P02** = IN_PROGRESS (`TC-P02-PLAN` ACCEPTED; T001–T010 ACCEPTED; `TC-P02-T011` awaiting architect review)
