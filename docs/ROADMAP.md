...
- **P05** = IN_PROGRESS (`TC-P05-T001` ACCEPTED · `TC-P05-T002` AWAITING_ARCHITECT_REVIEW)
...
**Progress:** `TC-P05-PLAN` ACCEPTED · `TC-P05-PLAN-R1` ACCEPTED · `TC-P05-T001` COMPLETE / ACCEPTED · `TC-P05-T002` AWAITING_ARCHITECT_REVIEW · P06 NOT_STARTED
