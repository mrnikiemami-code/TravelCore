...
- **P25** = IN_PROGRESS (module foundation; `TC-P25-T004` implemented / awaiting architect review)
...
**Status:** IN_PROGRESS (T004 module/schema foundation executed)
...
| P25 | Notification | IN_PROGRESS (T004 module foundation executed) |
