...
- **P05** = IN_PROGRESS (`TC-P05-T001`/`T002` ACCEPTED · `TC-P05-T003` + R1 ledger remediation awaiting review · **P05-R1 RESOLVED**)
...
**Progress:** `TC-P05-PLAN` ACCEPTED · `TC-P05-T001`/`T002` COMPLETE / ACCEPTED · `TC-P05-T003` AWAITING_ARCHITECT_REVIEW · `TC-P05-T003-R1` R1 ledger reconciliation · **P05-R1 RESOLVED** · P05-R2 UNRESOLVED · P06 NOT_STARTED
