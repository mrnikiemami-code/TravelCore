...
| Current Next Task | Architect review of `TC-P02-T003`; then `TC-P02-T004` when issued |
...
- **P00** = COMPLETE
- **P01** = COMPLETE
- **P02** = IN_PROGRESS (`TC-P02-PLAN` ACCEPTED; `TC-P02-T001`/`T002` ACCEPTED; `TC-P02-T003` awaiting architect review)
