...
- **P25** = IN_PROGRESS (plan authored; `TC-P25-T003` implemented / awaiting architect review)
...
**Status:** IN_PROGRESS (plan authored; T003 decision inventory + execution sequence executed)
...
| P25 | Notification | IN_PROGRESS (plan authored; T003 executed) |
