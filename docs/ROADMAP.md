...
| Current Next Task | Architect review of `TC-P02-T004`; then `TC-P02-T005` when issued |
...
- **P00** = COMPLETE
- **P01** = COMPLETE
- **P02** = IN_PROGRESS (`TC-P02-PLAN` ACCEPTED; T001–T003 ACCEPTED; `TC-P02-T004` awaiting architect review)
