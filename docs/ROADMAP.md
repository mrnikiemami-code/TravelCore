...
| Current Next Task | Architect review of `TC-P02-T012`; then `TC-P02-T013` when issued |
...
- **P00** = COMPLETE
- **P01** = COMPLETE
- **P02** = IN_PROGRESS (`TC-P02-PLAN` ACCEPTED; T001–T011 ACCEPTED; `TC-P02-T012` awaiting architect review)
