...
- **P09** = IN_PROGRESS (`TC-P09-PLAN` ACCEPTED · T001–T007 ACCEPTED · **T008 IN_PROGRESS** · **R1–R8 RESOLVED**)
...
**Progress:** T001–T007 ACCEPTED · **T008 IN_PROGRESS** (publishing + slug + SEO hooks) · **R1–R8 RESOLVED** (R4 Draft|Published|Inactive · R5 translation-owned slug · R6 default noindex,follow)
