...
**Status:** COMPLETE (`TC-P26-GATE` implemented · P26-R1–R8 RESOLVED · boundary-only graph foundation delivered)
...
**Implementation plan:** [`docs/plans/P27-implementation-plan.md`](plans/P27-implementation-plan.md) · **P27-R1–R8 RESOLVED**

---

## P28 — Performance & Scale

**Status:** **COMPLETE / ACCEPTED** — [`docs/plans/P28-GATE-acceptance-evidence.md`](plans/P28-GATE-acceptance-evidence.md) · **P28-R1–R8 ALL RESOLVED**
...
**Implementation plan:** [`docs/plans/P28-implementation-plan.md`](plans/P28-implementation-plan.md) · **P28-R1–R8 ALL RESOLVED**

---

## P29 — Production Hardening

**Status:** COMPLETE / ACCEPTED (`TC-P29-GATE`)
...
**Implementation plan:** [`docs/plans/P29-implementation-plan.md`](plans/P29-implementation-plan.md) · **P29-R1–R8 ALL RESOLVED**
...
1. Isolated feeder boundary — **DONE** (`tools/demofeed`)
...
**Status:** **GATE ACCEPTED WITH KNOWN LIMITATIONS** (`TC-P34-GATE` · `ee6684b`)

Non-production sandbox payment lifecycle through ConfirmIfEligible is closed.

Evidence: [`docs/product-experience/evidence/P34-GATE/GATE-REVIEW.md`](product-experience/evidence/P34-GATE/GATE-REVIEW.md)

---

## P35 — Production Payment Provider Readiness

**Status:** **ACTIVE / PAUSED AS P1** (provider research/design locks through T010; production adapters not launched)

Iran evaluation continues for Behpardakht + Zarinpal (no final pick). UAE Stripe preferred. Public UI polish prioritized via P36.

---

## P36 — Commercial UI/UX Final Polish

**Status:** **COMPLETE / GATE ACCEPTED WITH KNOWN LIMITATIONS** (`TC-P36-GATE`)

```text
PARTIALLY_SELLABLE_VISUALLY (Home + Hotels + Tours + Commerce)
```

Evidence: [`docs/product-experience/evidence/P36-GATE/`](product-experience/evidence/P36-GATE/)
...
Evidence: [`docs/product-experience/evidence/P37-GATE/GATE-REVIEW.md`](../product-experience/evidence/P37-GATE/GATE-REVIEW.md)
...
**Status:** **ACTIVE** (`TC-P38-T012` Cursor **PASS** · AgencyOffer Policy Operations Foundation)
...
Evidence: Policy Ops [`docs/product-experience/evidence/P38-T012/POLICY-OPS.md`](../product-experience/evidence/P38-T012/POLICY-OPS.md) · Policy [`docs/product-experience/evidence/P38-T011/POLICY-FOUNDATION.md`](../product-experience/evidence/P38-T011/POLICY-FOUNDATION.md)

Commerce Depth in progress: Admin governance + operational policy visibility — Commission/Settlement still deferred — await Architect `.task.md`
...
6. GATE: professional public / operable admin / sales agency feeling — ✅ (known limitations)

OUT of P30: DEMOFEED execution · new domain features · backend redesign (DEMOFEED moved to Post-P30 activation)
...
| P38 | Multi-Agency Commerce | **ACTIVE** (`TC-P38-T012` · Policy Ops PASS · Commerce Depth) |
