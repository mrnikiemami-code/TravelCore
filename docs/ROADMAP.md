...
|------|--------|
| Project | TravelCore |
| Current Phase | **P17 — Visa** (**IN PROGRESS** — T007 public Visa vs Content vs SEO) |
| Phase Status | P00–P16 COMPLETE · P17-R1–R7 RESOLVED · `TC-P17-T007` delivered |
...
| Current Next Task | Architect review of `TC-P17-T007` → next locked task (do not invent R8) |
...
- **P17** = IN PROGRESS — PLAN ACCEPTED · **P17-R1–R7 RESOLVED** · T007 public Visa vs Content vs SEO [`plans/P17-implementation-plan.md`](plans/P17-implementation-plan.md)
...
**Status:** IN PROGRESS — PLAN ACCEPTED · **P17-R1–R7 RESOLVED** · T007 public Visa vs Content vs SEO ([`docs/plans/P17-implementation-plan.md`](plans/P17-implementation-plan.md))
...
| P17 | Visa | **IN PROGRESS** (R1–R7 RESOLVED · T007) |
