...
| Current Next Task | Architect review of `TC-P36-T002` · do not auto-implement T003 |
...
**Status:** **ACTIVE** (`TC-P36-T002` Cursor **PASS** · Home redesign awaiting Architect)

```text
PARTIALLY_SELLABLE_VISUALLY (Home)
```

Evidence: [`docs/product-experience/evidence/P36-T002/`](../product-experience/evidence/P36-T002/)
...
| P36 | Commercial UI/UX Final Polish | **ACTIVE** (`TC-P36-T002` · Home PARTIALLY_SELLABLE) |
