...
- **P04** = IN_PROGRESS (`TC-P04-T001`–`T008` ACCEPTED; `TC-P04-T009` AWAITING_ARCHITECT_REVIEW; R3 RESOLVED = noindex,follow)
...
**Progress:** `TC-P04-T001`–`T008` COMPLETE / ACCEPTED · `TC-P04-T009` AWAITING_ARCHITECT_REVIEW · R3 RESOLVED (public Destination noindex,follow) · P05 NOT_STARTED
