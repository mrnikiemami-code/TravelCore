...
|------|--------|
| Project | TravelCore |
| Current Phase | **P25 — Notification** (**IN_PROGRESS** — `TC-P25-T006` implemented · provider abstraction) |
...
- **P25** = IN_PROGRESS (T006 provider abstraction implemented / awaiting architect review)
...
| P25 | Notification | IN_PROGRESS (T006 provider abstraction executed) |
