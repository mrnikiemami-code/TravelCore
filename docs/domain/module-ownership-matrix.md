...
| Pricing | Commerce | TourRate, PriceComponent, ExchangeRate, Quote, conversion | Tour contracts/IDs, ReferenceData | Tour catalog, Booking history, Payment execution | Tour DbContext, Booking, Payment, Search, SEO, Notification; premature Flight/HotelBooking fare ownership |
...
| TourProduct / TourDeparture / Itinerary / TourHotelOption | Tour |
