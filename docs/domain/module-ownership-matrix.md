...
| Search | Platform | Discovery/retrieval contracts; schema `search`; future read-model/projection | Events/contracts from publishers (later) | Authoritative Tour/Content/Pricing/Agency/Destination/Place/UGC/Visa facts; SEO IndexPolicy; Booking; Recommendation | Being required by core business transactions; no FTS/ranking/faceting engine in T001 |
