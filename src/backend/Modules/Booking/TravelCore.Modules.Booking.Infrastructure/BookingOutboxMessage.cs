...
/// <summary>
/// Booking-owned module-local transactional outbox row.
/// </summary>
public sealed class BookingOutboxMessage
{
        ...
        string payload)
    {
        ...
        return new BookingOutboxMessage(id, occurredAt, messageType, payload);
    }
