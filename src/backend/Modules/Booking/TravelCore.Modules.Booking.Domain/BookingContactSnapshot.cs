...
/// <summary>
/// Transaction-time Booker/contact facts (P19-R4). Not Party, Identity Account, or customer master.
/// </summary>
public sealed class BookingContactSnapshot
{
    public const int DisplayNameMaxLength = 200;
    public const int EmailMaxLength = 256;
    public const int PhoneMaxLength = 256;

    private BookingContactSnapshot(
        string? displayName,
        string? email,
    ...
    public static BookingContactSnapshot Create(
        ...
        string? phone = null)
    {
        ...
        {
            throw new ArgumentException("BookingContactSnapshot requires a display name, email, or phone.");
        }

        return new BookingContactSnapshot(normalizedDisplayName, rawEmail, normalizedEmail, normalizedPhone);
    }
