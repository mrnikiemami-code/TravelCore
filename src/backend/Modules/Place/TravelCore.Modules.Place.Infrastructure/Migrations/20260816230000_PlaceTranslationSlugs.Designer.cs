...
namespace TravelCore.Modules.Place.Infrastructure.Migrations
{
    ...
    [Migration("20260816230000_PlaceTranslationSlugs")]
    partial class PlaceTranslationSlugs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelCore.Modules.Place.Domain.PlaceFacility", b =>
                {
                    b.Property<Guid>("PlaceId")
                        .HasColumnType("uuid")
                        .HasColumnName("place_id");
                    ...
                    b.HasKey("PlaceId", "Code");

                    b.HasIndex("Code")
                        .HasDatabaseName("ix_place_facilities_code");

                    b.ToTable("place_facilities", "place");
                });

            modelBuilder.Entity("TravelCore.Modules.Place.Domain.PlaceMediaLink", b =>
                {
                    b.Property<Guid>("PlaceId")
                        .HasColumnType("uuid")
                        .HasColumnName("place_id");
                    ...
                    b.ToTable("place_media_links", "place");
                });
