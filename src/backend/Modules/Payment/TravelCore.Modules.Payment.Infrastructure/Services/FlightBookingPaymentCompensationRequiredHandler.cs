...
/// <summary>
/// Payment consumer of FlightBooking compensation-required. Event is a trigger; amount comes from snapshot.
/// </summary>
internal sealed class FlightBookingPaymentCompensationRequiredHandler : IFlightBookingPaymentCompensationRequiredHandler
{
    ...
    public FlightBookingPaymentCompensationRequiredHandler(
        PaymentDbContext db,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new InvalidOperationException("Flight compensation Payment does not belong to the FlightBooking.");
        }

        if (payment.Status != PaymentStatus.Succeeded)
        {
            throw new InvalidOperationException("Flight compensation requires a Succeeded Payment.");
        }

        if (payment.ExecutionSnapshot is null)
        {
            throw new InvalidOperationException("Flight compensation requires PaymentExecutionSnapshot.");
        }
