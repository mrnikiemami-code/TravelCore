...
namespace TravelCore.Modules.Payment.Infrastructure.Migrations
{
    ...
    [Migration("20260818120000_AddPaymentIdempotencyAndReconciliation")]
    partial class AddPaymentIdempotencyAndReconciliation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TravelCore.Modules.Payment.Domain.PaymentReconciliationIssue", b =>
                {
                    ...
                    b.ToTable("payment_reconciliation_issues", "payment", t =>
                        {
                            t.HasCheckConstraint("ck_payment_reconciliation_issues_kind", "kind IN (1, 2)");
                        });
                });
