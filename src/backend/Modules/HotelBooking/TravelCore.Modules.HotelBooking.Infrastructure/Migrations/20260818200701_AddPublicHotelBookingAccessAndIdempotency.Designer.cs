...
namespace TravelCore.Modules.HotelBooking.Infrastructure.Migrations
{
    ...
    [Migration("20260818200701_AddPublicHotelBookingAccessAndIdempotency")]
    partial class AddPublicHotelBookingAccessAndIdempotency
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelCore.Modules.HotelBooking.Domain.HotelBookingAccessCredential", b =>
                {
                    b.Property<Guid>("HotelBookingId")
                        .HasColumnType("uuid")
                        .HasColumnName("hotel_booking_id");
                    ...
                    b.ToTable("hotel_booking_access_credentials", "hotel_booking");
                });
            ...
            modelBuilder.Entity("TravelCore.Modules.HotelBooking.Domain.HotelBookingPublicIdempotencyRecord", b =>
                {
                    b.Property<string>("IdempotencyKey")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.ToTable("hotel_booking_public_idempotency", "hotel_booking");
                });
