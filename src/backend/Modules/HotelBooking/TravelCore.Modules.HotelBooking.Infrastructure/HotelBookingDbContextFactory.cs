...
/// </summary>
public sealed class HotelBookingDbContextFactory : IDesignTimeDbContextFactory<HotelBookingDbContext>
{
    private const string DesignTimeConnectionString =
        "Host=localhost;Database=travelcore_hotel_booking_design;Username=travelcore_design;Password=not-a-real-secret";
