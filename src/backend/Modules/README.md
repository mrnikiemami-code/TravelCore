...
- **AgencyMarketplace:** AgencyProfile + AgencyOffer (`TC-P13-T002`–`T005`) — schema `agency_marketplace`; Offer = market listing with logical TourProduct Guid; commercial terms without Price; sales availability without capacity.
