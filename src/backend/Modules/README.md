...
- **Visa:** VisaDefinition + RequirementSet + Applicability + RequiredDocument + EligibilityRequirement (`TC-P17-T004`) — schema `visa`; **RequiredDocument != EligibilityRequirement**; **EligibilityRequirement != Rules Engine**; no fees/application/upload tables; no peer FK.
