...
- **AgencyMarketplace:** AgencyProfile + AgencyOffer (`TC-P13-T002`–`T004`) — schema `agency_marketplace`; Offer = market listing with logical TourProduct Guid; commercial terms = Notes + SalesRules (no Price/Booking/Commission).
