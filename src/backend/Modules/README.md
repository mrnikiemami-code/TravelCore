...
- Invariant: **Booking != Tour · Booking != TourDeparture · Booking != Price · Booking != Quote · Booking != Payment · Booking != Lead · Booking != VisaApplication**. **BookingStatus != PaymentStatus**. **CapacityDefinition != CapacityConsumption**. **CapacityHoldStatus != BookingStatus**.
