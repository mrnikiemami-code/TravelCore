...
const ALLOWED_USE_CLIENT = new Set([
  ...
  path.normalize("features/booking/status-view.tsx"),
  path.normalize("features/flight-booking/search-form.tsx"),
  path.normalize("features/flight-booking/payment-view.tsx"),
  path.normalize("features/flight-booking/status-view.tsx"),
  path.normalize("features/hotel-booking/prepare-form.tsx"),
  path.normalize("features/hotel-booking/payment-view.tsx"),
  path.normalize("features/hotel-booking/status-view.tsx"),
