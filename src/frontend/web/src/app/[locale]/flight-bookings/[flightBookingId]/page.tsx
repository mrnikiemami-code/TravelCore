...
import { PublicFlightBookingStatusView } from "@/features/flight-booking/status-view";
...
/**
 * Authorized private FlightBooking read (TC-P22-T008 / P22-R8).
...
export default async function PublicFlightBookingStatusPage({ params }: PageProps) {
    ...
    >
      <div className="py-6 sm:py-8">
        <div className="mx-auto w-full max-w-xl px-4">
          <PublicFlightBookingStatusView locale={locale} flightBookingId={flightBookingId} />
        </div>
      </div>
    </PublicShell>
  );
