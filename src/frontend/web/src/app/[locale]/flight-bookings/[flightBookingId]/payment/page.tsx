...
/**
 * Authorized private FlightBooking payment (TC-P22-T008 / P22-R8).
...
export default async function PublicFlightBookingPaymentPage({ params }: PageProps) {
    ...
    >
      <div className="py-6 sm:py-8">
        <div className="mx-auto w-full max-w-xl px-4">
          <PublicFlightBookingPaymentView locale={locale} flightBookingId={flightBookingId} />
        </div>
      </div>
    </PublicShell>
  );
