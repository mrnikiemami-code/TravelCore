...
/**
 * Provider browser-return navigation only (TC-P20-T007 / P20-R7).
...
export default async function PublicBookingPaymentReturnPage({ params }: PageProps) {
