...
/**
 * Provider browser-return navigation only (TC-P21-T008 / P21-R8).
...
export default async function PublicHotelBookingPaymentReturnPage({ params }: PageProps) {
